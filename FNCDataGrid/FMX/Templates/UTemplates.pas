...
uses
  ...
  FlexCel.FMXSupport, FlexCel.Core, FlexCel.XlsAdapter, FMX.TMSFNCTypes,
  ...
  FMX.TMSFNCDataGridExcelExport, FMX.StdCtrls, FMX.TMSFNCCustomControl,
  FMX.TMSFNCDataGrid, FMX.Controls.Presentation;
