...
uses
  ...
  ExtCtrls,
  FlexCel.VCLSupport, FlexCel.Core, FlexCel.Render, FlexCel.XlsAdapter,
  System.UITypes, VCL.TMSFNCTypes, VCL.TMSFNCUtils, VCL.TMSFNCGraphics,
...
begin
  ShowMessage('This example shows how to convert formatting between the Grid and Excel. '+
    'Excel and FNCDataGrid use incompatible format strings, so you need to tell TMSFNCDataGridExcelExport ' +
