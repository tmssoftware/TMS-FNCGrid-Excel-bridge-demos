# Examples for TMS FNC Grid-Excel Bridge
...
## New in v 3.5 - November 2025


- **Support for exporting FNCDataGrid besides FNCGrid.** Adds support for exporting the new [FNCDataGrid](https://www.tmssoftware.com/site/tmsfncuipack-grid.asp)
